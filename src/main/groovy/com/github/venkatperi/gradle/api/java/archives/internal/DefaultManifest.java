 ...
 * @author Hans Dockter
 */
public class DefaultManifest implements com.github.venkatperi.gradle.api.java.archives.Manifest {
    ...
    private void addAttributesToAnt(Manifest antManifest) {
        for (Map.Entry<String, Object> entry : attributes.entrySet()) {
            try {
                antManifest.addConfiguredAttribute(new Attribute(entry.getKey().toString(),
                        entry.getValue().toString()));
            } catch (ManifestException e) {
                throw new com.github.venkatperi.gradle.api.java.archives.ManifestException(e.getMessage(), e);
            }
        }
    }
    ...
    public com.github.venkatperi.gradle.api.java.archives.Manifest writeTo(Object path) {
        try {
