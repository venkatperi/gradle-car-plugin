...
import com.github.venkatperi.gradle.api.java.archives.ManifestMergeDetails;
...
public class DefaultManifestMergeSpec implements ManifestMergeSpec {
    ...
    private DefaultManifestMergeDetails getMergeDetails(String section, String key, Object baseValue, Object mergeValue) {
        String value = null;
        String baseValueString = baseValue != null ? QuotedString.toString(baseValue) : null;
        String mergeValueString = mergeValue != null ? QuotedString.toString(mergeValue) : null;
